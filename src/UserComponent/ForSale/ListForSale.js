...
import Duannoibat from "./ForSale";
...
function ListForSale(){
          ...
          if(isMobile3){
              return(
                ...
                <div className =" container">
                     <a className="duannoibat-a" href="/project"><span className="duannoibat-span">Real Estate For Sale</span></a>
                                           <Slider  nav className="my-carousel" {...settings3}>
                            {duan.map(da=>{
                                return(
                                <Duannoibat duan = {da} key={duan.maduan} />
                                )
                            })}
    ...
    return(      
        <div className =" Duannoibat">
                <div className =" container">
                <a className="duannoibat-a" href="/project"><span className="duannoibat-span">Real Estate For Sale</span><br/><img style={{marginBottom:"2%", marginTop:'1%'}} src={hinh}/></a>
                
                        <Slider  nav className="my-carousel" {...settings}>
                            
                            {duan.map(da=>{
                                return(     
                                <ForSale duan = {da} key={duan.maduan} />
                                )
                            })}
