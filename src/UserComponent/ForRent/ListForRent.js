...
import Duannoibat from "./ForRent";
...
function ListForRent(){
          ...
          if(isMobile3){
              return(
                ...
                <div className =" container">
                     <a className="duannoibat-a" href="/project"><span className="duannoibat-span">Real Estate For Rent</span></a>
                       
                        <Slider  nav className="my-carousel" {...settings3}>
                            {duan.map(da=>{
                                return(
                                <ForRent duan = {da} key={duan.maduan} />
                                )
                            })}
    ...
    return(      
        <div className =" Duannoibat">
                <div className =" container">
                <a className="duannoibat-a" href="/project"><span className="duannoibat-span">Real Estate For Rent</span><br/><img style={{marginBottom:"2%", marginTop:'1%'}} src={hinh}/></a>
